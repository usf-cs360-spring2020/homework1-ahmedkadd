...
let airlines = ["United Airlines", "Alaska Airlines", "Delta Air Lines", "SkyWest Airlines", "American Airlines", "Southwest Airlines", "JetBlue Airways", "Frontier Airlines", "Hawaiian Airlines", "Compass Airlines", "Horizon Air", "Sun Country Airlines"];
let dataset = d3.csv("data2.csv");
...
function draw(data) {
  ...
  let count = new Map(data.map(i => [i.airline, i.count]));
